...
void main() {
  ...
  group('getLastNumberTrivia', () {
    final tNumberTriviaModel = NumberTriviaModel.fromJson(
        json.decode(fixture('trivia_json_cached.json')));
    test(
        'should return NumberTrivia from SharedPreferences where then is one in the cache',
        () async {
      //arrange
      when(mockSharedPreferences.getString(any))
          .thenReturn(fixture('trivia_json_cached.json'));
      //act
